...
steptrainerlanding_node1758802676991 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-human-balance-analytics-2025/step-trainer/step-trainer_landing/"], "recurse": True}, transformation_ctx="steptrainerlanding_node1758802676991")

# Script generated for node customer curated
customercurated_node1758802615508 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-human-balance-analytics-2025/customer/customer_curated/"], "recurse": True}, transformation_ctx="customercurated_node1758802615508")
...
'''
SQLQuery_node1758781200220 = sparkSqlQuery(glueContext, query = SqlQuery3900, mapping = {"c":customercurated_node1758802615508, "l":steptrainerlanding_node1758802676991}, transformation_ctx = "SQLQuery_node1758781200220")
