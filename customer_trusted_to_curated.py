...
Accelerometerlanding_node1758779435017 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_landing", transformation_ctx="Accelerometerlanding_node1758779435017")
...
Join_node1758779566291 = Join.apply(frame1=Accelerometerlanding_node1758779435017, frame2=customertrusted_node1758779438609, keys1=["user"], keys2=["email"], transformation_ctx="Join_node1758779566291")
...
'''
SQLQuery_node1758779679739 = sparkSqlQuery(glueContext, query = SqlQuery3549, mapping = {"myDataSource":Join_node1758779566291}, transformation_ctx = "SQLQuery_node1758779679739")
