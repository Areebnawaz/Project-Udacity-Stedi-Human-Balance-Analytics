...
Accelerometerlanding_node1758801439321 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-human-balance-analytics-2025/accelerometer/accelerometer_landing/"], "recurse": True}, transformation_ctx="Accelerometerlanding_node1758801439321")

# Script generated for node customer trusted
customertrusted_node1758801497741 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-human-balance-analytics-2025/customer/customer_trusted/"], "recurse": True}, transformation_ctx="customertrusted_node1758801497741")

# Script generated for node Join
Join_node1758778552309 = Join.apply(frame1=Accelerometerlanding_node1758801439321, frame2=customertrusted_node1758801497741, keys1=["user"], keys2=["email"], transformation_ctx="Join_node1758778552309")
...
'''
SQLQuery_node1758778642724 = sparkSqlQuery(glueContext, query = SqlQuery3707, mapping = {"myDataSource":Join_node1758778552309}, transformation_ctx = "SQLQuery_node1758778642724")
